  ...
  return (
    <>
      <div className="flex relative flex-col flex-nowrap gap-4 justify-around items-start mb-8 w-full md:flex-row md:items-center">
        <span className="absolute z-0 w-0 h-[calc(100%+1rem)] border-l-4 border-mustard-300 md:w-full md:h-1 md:border-0 md:border-r-0 md:border-t-4"></span>
        {data.map((val, index) => (
          <button
          ...
          >
            ...
            <span
              ...
              className={`inline-block p-2 rounded-full border-4 ${
                selectedIndex === index
                  ? "bg-mustard-700 border-mustard-300"
                  : "bg-white border-mustard-300"
